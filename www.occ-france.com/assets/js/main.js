...
$(function() {
	...
	$(document).ready(function() {
		...
		$('body').on('animsition.inEnd', function(){
			...
			if(filterValue==".ambassadeur"){
				$('.works').addClass('padd');
			}else {$('.works').removeClass('padd');}

			$('.filter-button-box').removeClass('active');
			$(this).addClass('active');
			$('.works a').hide();
			$('.works a'+filterValue).show();
...
//
			//	});
			//	$gridt.isotope({ filter: '.tous' });
			//	$('.filter-buttons').on('click', 'button', function () {
			//		var filterValue = $(this).attr('data-filter');
			//		if(filterValue==".ambassadeur"){
			//			$('.works').css('padding-left','200px').css('padding-right','200px');
			//		}
			//		$gridt.isotope({
			//			filter: filterValue,
//
			...
			//};
			//projectFilter();
			//$('.filter-buttons.active').trigger('click');
