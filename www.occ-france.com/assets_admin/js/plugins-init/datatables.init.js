...
(function($) {
    ...
    var table = $('#example').DataTable({
        "lengthMenu": [[100, 500, 1000, -1], [100, 500, 1000, "Tous"]],
        "language": {
            "lengthMenu": "Voir _MENU_ membres par page",
            "zeroRecords": "Aucune données",
            "info": "Voir page _PAGE_ de _PAGES_",
    ...
    var table = $('#example2').DataTable({
     ...
     var table3 = $('#exproduit').DataTable({
        "language": {
            "lengthMenu": "Voir _MENU_ membres par page",
            "zeroRecords": "Aucune données",
            "info": "Voir page _PAGE_ de _PAGES_",
